...
  // MODIFIED: Only updates local state
  const handleSearchChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    const value = e.target.value;
    setLocalSearch(value);
  };

  // NEW: Function to execute the search on backend
...
    "Preference": product.preference?.toString() || "1",
...
        <input
          type="text"
          placeholder="Search products Global (Press Enter or click Search)"
          value={localSearch}
